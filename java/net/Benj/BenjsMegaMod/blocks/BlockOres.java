...
import net.Benj.BenjsMegaMod.Util.IMetaName;
import net.Benj.BenjsMegaMod.Util.Reference;
import net.Benj.BenjsMegaMod.Util.handlers.EnumHandler;
import net.Benj.BenjsMegaMod.blocks.item.ItemBlockVariants;
...
public class BlockOres extends Block implements IHasModel, IMetaName {
	...
	public BlockOres(String name, String dimension, CreativeTabs creativetab) {
		super(Material.ROCK);

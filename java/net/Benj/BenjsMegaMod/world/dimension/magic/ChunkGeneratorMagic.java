...
public class ChunkGeneratorMagic implements IChunkGenerator {
    ...
    protected static final IBlockState OTHER_BLOCK1 = Blocks.DIRT.getDefaultState();
   ...
   // private final WorldGenStructure HOUSE = new WorldGenStructure("House");
    ...
    public ChunkGeneratorMagic(World world, boolean generate, long seed)
    {
        this.world = world;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.MAGIC_DIMENSION);
        }
